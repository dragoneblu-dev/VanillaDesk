 ...
 * per prevenire l'eccezione TypeError 'closest is not a function' su trascinamento di testo evidenziato.
 */
    ...
    init: () => {
        ...
        editorEl.addEventListener('input', () => {
            if (!AppState.isSwitchingNote) {
                // Auto-riparazione immediata di eventuali span parassiti iniettati dal browser su unione blocchi
